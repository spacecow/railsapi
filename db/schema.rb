...
ActiveRecord::Schema.define(version: 20160902072406) do
  ...
  add_index "articles", ["name", "universe_id"], name: "index_articles_on_name_and_universe_id", unique: true, using: :btree
