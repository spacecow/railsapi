class Factory
  ...
  def create_article_mention params; FactoryGirl.create :article_mention, params end 
  def delete_article_mentions; ArticleMention.destroy_all end
  ...
  def delete_citations; Citation.destroy_all end 
